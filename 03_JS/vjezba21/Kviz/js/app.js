...
createApp({
    ...
    computed: {
        ...
        progres() {
            return (this.indeks / this.ukupnoPitanja) * 100;
        },
        izracunajPostotak(){
            if(this.rezultat===0){
                return '0 %';
            }else{
                const postotak = (this.rezultat / this.ukupnoPitanja)*100;
    ...
    methods: {
        ...
        obradiOdgovor(odabrano) {
            ...
            if (this.indeks < this.ukupnoPitanja-1) {
                this.indeks++;
            } else {
